...
filenames <- list.files("Outputs/unburnt3s/2007", full.names = TRUE)
prefix <- "Outputs/unburnt3s/2007/"
output <- "Outputs/unburnt3s/plotly2007"
...
filenames <- list.files("Outputs/unburnt3s/2016", full.names = TRUE)
prefix <- "Outputs/unburnt3s/2016/"
output <- "Outputs/unburnt3s/plotly2016"
...
plots2016 <- list.files("outputs/unburnt3s/plotly2016")
plots2007 <- list.files("outputs/unburnt3s/plotly2007")
...
for(i in 1:nrow(matching)){
  ...
  image1 <- image_trim(image_read(paste0("Outputs/unburnt3s/plotly2007/", file2007)))
  image2 <- image_trim(image_read(paste0("Outputs/unburnt3s/plotly2016/", file2016)))
  
  combined <- image_append(c(image1, image2))
  image_write(combined, path = paste0("Outputs/unburnt3s/unburnt3s/", name, ".png"), format = "png")
